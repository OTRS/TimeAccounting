        ...
        )
    {
            ...
            )
        {
            $LayoutObject->Block(
                ...
                Data => {
                    Description =>
                        Translatable('This Date is out of limit, but you haven\'t insert this day yet, so you get one(!) chance to insert'),
                },
            );
        }
    }
...
sub _FirstUserRedirect {
    ...
    return $LayoutObject->ErrorScreen(
        Message => Translatable('No time period configured, or the specified date is outside of the defined time periods. Please contact the time accounting admin to update your time periods!'),
    );
}
