...
sub Data {
    ...
    $Self->{Translation}->{'Go to this date'} = 'Idi na ovaj dan';
    ...
    $Self->{Translation}->{'Start Time'} = 'Vreme početka';
    ...
    $Self->{Translation}->{'End Time'} = 'Vreme završetka';
    ...
    $Self->{Translation}->{'Filter for Projects'} = 'Filter za projekte';
    $Self->{Translation}->{'Filter for Tasks'} = 'Filter za zadatke';
    $Self->{Translation}->{'Filter for Users'} = 'Filter za korisnike';
    ...
    $Self->{Translation}->{'New User Settings'} = 'Nova korisnička podešavanja';
    $Self->{Translation}->{'Edit User Settings'} = 'Uredi korisnička podešavanja';
    $Self->{Translation}->{'Comments'} = 'Komentari';
