...
sub Data {
    ...
    $Self->{Translation}->{'Go to this date'} = 'Отидете на тази дата';
    ...
    $Self->{Translation}->{'Start Time'} = 'Начално време';
    ...
    $Self->{Translation}->{'End Time'} = 'Край';
    ...
    $Self->{Translation}->{'Filter for Projects'} = 'Филтър на проекта';
    $Self->{Translation}->{'Filter for Tasks'} = 'Филтър за задачи';
    $Self->{Translation}->{'Filter for Users'} = 'Филтър на потребители';
    ...
    $Self->{Translation}->{'New User Settings'} = 'Настройки на нов потребител';
    $Self->{Translation}->{'Edit User Settings'} = 'Редактиране на потребителските настройки';
