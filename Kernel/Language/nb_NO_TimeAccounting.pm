...
sub Data {
    ...
    $Self->{Translation}->{'Go to this date'} = 'Gå til denne datoen';
    ...
    $Self->{Translation}->{'End Time'} = 'Sluttid';
    ...
    $Self->{Translation}->{'Show all items'} = 'Vis alle registreringer';
    ...
    $Self->{Translation}->{'Filter for Projects'} = 'Filter for prosjekter';
    $Self->{Translation}->{'Filter for Tasks'} = 'Filter for aktiviteter';
    $Self->{Translation}->{'Filter for Users'} = 'Filter for brukere';
    ...
    $Self->{Translation}->{'New User Settings'} = 'Nye innstillinger for bruker';
    $Self->{Translation}->{'Edit User Settings'} = 'Endre instillinger for bruker';
    $Self->{Translation}->{'Comments'} = 'Merknader';
